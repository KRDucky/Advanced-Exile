...
private["_vehicleObject","_vehicleID","_position","_vectorDirection","_vectorUp","_availableHitpoints","_vehicleHitpoints","_data","_extDB3Message"];
...
if (_vehicleID > -1) then
{
	...
	_extDB3Message = ["updateVehicle", _data] call ExileServer_util_extDB3_createMessage;
